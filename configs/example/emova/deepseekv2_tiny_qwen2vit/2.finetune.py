...
model_args = dict(
    ...
    language_model=dict(trainable=True,
                        ...
                        pretrained_model_name_or_path="./logdir/emova-deepseek-vl2-tiny-qwen2vit600m-alignment/",
                        ),
...
training_args = dict(
    output_dir="./logdir/emova-deepseek-vl2-tiny-qwen2vit600m-alignment/-finetune/",
