...
model_args = dict(
    ...
    language_model=dict(trainable=True,
                        ...
                        pretrained_model_name_or_path="./logdir/emova-llama3_1-8b-internvit-anyres-9slices-alignment/",
                        ),
...
training_args = dict(
    output_dir="./logdir/emova-llama3_1-8b-internvit-anyres-9slices-finetune/",
