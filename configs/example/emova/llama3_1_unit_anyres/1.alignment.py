...
model_args = dict(
    version="llama3",
    pretrain_mm_mlp_adapter="./logdir/emova-llama3_1-8b-unit1b-anyres-9slices-pretrain/mm_projector.bin",
...
training_args = dict(
    output_dir="./logdir/emova-llama3_1-8b-unit1b-anyres-9slices-alignment/",
