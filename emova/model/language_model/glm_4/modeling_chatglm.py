...
class ChatGLMPreTrainedModel(PreTrainedModel):
    ...
    def get_masks(self, batch_size, seq_length, device, past_key_values, padding_mask=None):
    ...
    def forward(
        ...
        if full_attention_mask is None:
            if (attention_mask is not None and not attention_mask.all()) or (past_key_values and seq_length != 1):
                full_attention_mask = self.get_masks(batch_size, seq_length, inputs_embeds.device,
