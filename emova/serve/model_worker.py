...
class ModelWorker:
    def __init__(self, controller_addr, worker_addr,
        ...
        self.is_multimodal = 'emova' in self.model_name.lower()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--multi-modal", action="store_true",
                        help="Multimodal mode is automatically detected with model name, please make sure `emova` is included in the model path.")
    ...
    if args.multi_modal:
        logger.warning(
            "Multimodal mode is automatically detected with model name, please make sure `emova` is included in the model path.")
